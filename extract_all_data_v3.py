...
stats_dir = 'runs/chipletization/decode_to_rename_v3/stats'
...
for simulation in grouped_folders:
    ...
    for partition in grouped_folders[simulation]:
        ...
        sim_2_path = os.path.join(stats_dir, f"{simulation}_r_{partition}_i1", "stats.txt")
        ...
        sim_2_stats_path = os.path.join(stats_dir, f"{simulation}_r_{partition}_i1", "stats.txt")
