...
def extract_parameters(config_file):
    ...
    with open(config_file, 'r') as file:
        ...
        for i, line in enumerate(lines):
            if line.startswith('iewToFetchDelay'):
                params['iewToFetchDelay'] = line.strip().split('=')[1].strip()
    return params
...
def process_simulations(main_folder):
        ...
        if os.path.isdir(sim_path):
            ...
            if os.path.exists(config_file) and os.path.exists(stats_file):
                ...
                simulation_data = {
                    ...
                    'iewToFetchDelay': params.get('iewToFetchDelay', ''),
    ...
    with open(csv_filename, 'w', newline='') as csvfile:
        fieldnames = ['simulation_name', 'iewToFetchDelay', 'cycle_count']
